...
- 2026-03-14: [DONE] Reverted the attempted Ghostty `Cmd+Shift+T` chained-keybind picker-tab experiment after live validation showed the follow-up input could land in the wrong tab; kept the stable shared helper + Ghostty AppleScript path for controller `Share`.
...
- 2026-03-15: [DONE] Unassigned Ghostty `Y` so the face button is free for a future remap.
